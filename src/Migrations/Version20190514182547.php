 ...
 */
final class Version20190514182547 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP subscribed_categories');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD subscribed_categories LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
